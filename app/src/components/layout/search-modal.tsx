                  ...
                  <div className="mb-8">
                    ...
                    {loading ? (
                      ...
                      <div className="text-center py-16 px-4">
                        ...
                        <p className="text-gray-700 font-medium mb-1">No products found for &ldquo;{searchQuery}&rdquo;</p>
                        <p className="text-sm text-gray-500">Try using different keywords or browse popular products below</p>
                      </div>
                    )}
                  </div>
                )}
