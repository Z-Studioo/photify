...
const SelectPhoto: React.FC<SelectPhotoProps> = ({ onPhotoSelected }) => {
  ...
  const triggerFileUpload = () => {
    const fileInput = document.getElementById("select-photo-input") as HTMLInputElement
    fileInput?.click()
  }
    ...
    return (
      <div className="relative overflow-auto p-4">
        ...
        <MyPhotos
          ...
          onUploadMore={() => {
            const fileInput = document.getElementById("my-photos-input") as HTMLInputElement
            fileInput?.click()
          }}
    ...
    <div className="relative overflow-auto p-4">
      ...
      <div className="flex flex-col space-y-6">
        ...
        <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center space-y-4 bg-white">
          ...
          <p className="text-lg font-light text-gray-700">Drag and Drop Your Files Here</p>
          <p className="text-xs text-gray-500 text-center">
            JPG, PNG format, min 700x700px, max 50000x50000px or 1000MP, max 2GB. <br />
          ...
          />
          <Button variant="default" onClick={triggerFileUpload} className="px-6 py-3 rounded-none">
            Upload Photo
          </Button>
          <p className="text-sm text-gray-500">
            Please <span className="underline cursor-pointer hover:no-underline">login</span> to upload
          </p>
        </div>
