...
const RoomFrame3D = ({ imageUrl, shape, onInteraction }: { imageUrl: string; shape: CanvasShape; onInteraction: () => void }) => {
    ...
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-60 cursor-pointer">
      ...
      >
        <Suspense fallback={null}>
          ...
          {/* Frame with image */}
          {preview && (
            <RoomFrame3D imageUrl={preview} shape={shape} onInteraction={onInteraction} />
          )}
