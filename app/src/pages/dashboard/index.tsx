    ...
    <div className='h-screen flex flex-col overflow-hidden'>
      ...
      <div className='flex-1 w-full flex flex-col md:flex-row gap-0 overflow-hidden'>
          ...
          <div className='md:w-8/12 w-full relative h-64 md:h-full overflow-hidden'>
            ...
            >
              ...
              <motion.button
                ...
                className='cursor-pointer absolute left-4 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-white p-3 rounded-full shadow-lg transition-all z-10 flex-shrink-0'
                type='button'
              ...
              <motion.button
                ...
                className='cursor-pointer absolute right-4 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-white p-3 rounded-full shadow-lg transition-all z-10 flex-shrink-0'
                type='button'
                style={{ width: '48px', height: '48px' }}
                initial={{ opacity: 0, x: 20 }}
                animate={{ opacity: 1, x: 0 }}
            ...
            {/* Top overlay buttons - with fixed positioning */}
            <div
              className='fixed left-0 right-0 flex justify-between items-start md:w-8/12 top-16 md:top-18 md:px-4 pointer-events-none z-20'
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
              >
                <ImagePlus className='h-4 w-4 md:h-5 md:w-5 mb-1 flex-shrink-0' />
              ...
              <motion.div
                className='flex gap-2 pointer-events-auto flex-shrink-0'
        ...
        <div className='md:w-1/3 w-full flex flex-col border-l md:h-full flex-1 md:flex-none md:overflow-hidden overflow-y-auto'>
          ...
          <AnimatePresence mode='wait'>
            {!selectedFeature && (
              <motion.div
                ...
                className='flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 sm:p-6 overflow-visible flex-shrink-0 w-full'
              >
          ...
          <motion.div
            className='relative md:overflow-hidden flex-1 min-h-0'
            layout
            transition={{ duration: 0.3, ease: [0.22, 1, 0.36, 1] }}
          >
            <motion.div
              className='md:absolute md:inset-0 flex flex-col'
              animate={{ x: selectedFeature ? '-100%' : '0%' }}
              transition={{ duration: 0.3, ease: [0.22, 1, 0.36, 1] }}
            >
              <ScrollArea className='md:h-full flex-1 md:flex-none'>
                <motion.div
                    ...
                    >
                      <motion.div
                        data-tour={`feature-${item.name
                          .toLowerCase()
                          .replace(/\s+/g, '-')}`}
                        className={`flex items-center justify-between p-4 md:p-6 relative overflow-hidden group hover:bg-gray-50 ${
                      ...
                      {index !== features.length - 1 && (
                        <motion.div
                          className='border-b border-gray-200 w-full flex-shrink-0'
                          initial={{ scaleX: 0 }}
                          animate={{ scaleX: 1 }}
                          transition={{
