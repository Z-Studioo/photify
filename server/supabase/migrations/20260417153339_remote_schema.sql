...
COMMENT ON COLUMN "public"."art_products"."aspect_ratio_id" IS 'Single aspect ratio for all sizes (1:1, 3:4, etc.)';
...
CREATE TABLE IF NOT EXISTS "public"."products" (
    ...
    "search_text" "text" GENERATED ALWAYS AS (((("name")::"text" || ' '::"text") || COALESCE("description", ''::"text"))) STORED,
...
CREATE INDEX "idx_art_products_aspect_ratio" ON "public"."art_products" USING "btree" ("aspect_ratio_id");
...
CREATE INDEX "idx_products_name_embedding" ON "public"."products" USING "ivfflat" ("name_embedding" "public"."vector_cosine_ops") WITH ("lists"='100');

CREATE INDEX "idx_products_product_type" ON "public"."products" USING "btree" ("product_type");

CREATE INDEX "idx_products_search_text" ON "public"."products" USING "gin" ("to_tsvector"('"english"'::"regconfig", "search_text"));
...
ALTER TABLE ONLY "public"."art_products"
    ADD CONSTRAINT "art_products_aspect_ratio_id_fkey" FOREIGN KEY ("aspect_ratio_id") REFERENCES "public"."aspect_ratios"("id") ON DELETE SET NULL;
...
CREATE POLICY "Public read ai_tools" ON "public"."ai_tools" FOR SELECT USING (("is_active" = true));
...
GRANT ALL ON TABLE "public"."ai_tools" TO "anon";

GRANT ALL ON TABLE "public"."ai_tools" TO "authenticated";
