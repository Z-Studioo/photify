...
| `20260612130000` | `20260612130000_promo_case_insensitive_and_auto_rpc.sql` | Case-insensitive `is_promotion_valid`; `get_active_auto_promo()` RPC for FE auto-apply fetch.                                                                                               |
